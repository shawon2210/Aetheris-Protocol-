...
export function HeroModule() {
  ...
  return (
    <div className="relative w-full max-w-5xl flex items-center justify-center mb-24 orbiting-content">
      <GlassPanel
        className="relative z-10 text-center space-y-8 p-12 rounded-xl border-primary/20 shadow-2xl overflow-hidden"
      >
        <div className="inline-flex items-center gap-3 px-6 py-2 glass-ui rounded-full bg-surface-container-low border-primary/30">
          <span className="w-2.5 h-2.5 rounded-full bg-primary-container digital-pulse shadow-[0_0_15px_#00f0ff]" />
          <span className="font-label-mono text-[11px] text-primary tracking-[0.35em] uppercase font-bold">
            Orbital Link: {session ? session.sector : '7G_Sector'}
          </span>
        </div>
        <h2 className="font-display-lg text-display-lg hero-title uppercase drop-shadow-[0_0_50px_rgba(0,219,233,0.45)]">
          Aetheris Protocol
        </h2>
        <p className="font-body-md text-on-surface-variant max-w-2xl mx-auto leading-relaxed text-lg font-light">
