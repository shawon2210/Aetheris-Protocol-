...
export function NetworkLatencyIndicator() {
  ...
  return (
    <div className="fixed bottom-12 right-margin-desktop z-30 pointer-events-none text-right">
      ...
      <div className="flex items-center gap-3 justify-end">
        ...
        <span className="font-data-readout text-[14px] text-primary font-bold">
